...
class InProgressTaskProvider with ChangeNotifier {
  ...
  Future<void> fetchInProgressTasks(String workerId) async {
    final url = '${URL.url}/worker_inprogress_tasks.php?worker_id=$workerId';

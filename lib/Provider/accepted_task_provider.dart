...
class AcceptedTaskProvider with ChangeNotifier {
  ...
  Future<void> fetchAcceptedTasks(String workerId) async {
    final url = '${URL.url}/worker_accepted_tasks.php?worker_id=$workerId';
